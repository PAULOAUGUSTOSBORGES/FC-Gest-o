...
// ==========================================
// MIGRAƒ€ƒO AUTOMƒƒTICA DO BANCO ANTIGO
// ==========================================
...
// ==========================================
// 3. FINANCEIRO E CAIXA Fƒƒ€šSICO
// ==========================================
...
// ==========================================
// 5. MODAL DE CADASTRO/EDIƒ€ƒO DE CONTA (COM RECORRƒƒ€ NCIA)
// ==========================================
...
function exportarDadosParaIA() {
    ...
    let relatorioTexto = `=== RELATRIO FINANCEIRO E DE GESTO - FC Mƒ€œVEIS ===\nData da exportao: ${new Date().toLocaleString('pt-BR')}\n\n`;
    ...
    relatorioTexto += `\n--- 3. MOVIMENTAƒ€ƒES FINANCEIRAS / CAIXA ---\n`;
...
// NOVO: Funes auxiliares para Vƒ-nculo de XML
