...
function salvarProduto() {
    ...
    const p = {
        ...
        margem: (parseInputMoney(document.getElementById('prod-custo').value) || 0) > 0 ? parseFloat((((preco - (parseInputMoney(document.getElementById('prod-custo').value) || 0)) / (parseInputMoney(document.getElementById('prod-custo').value) || 0)) * 100).toFixed(2)) : (parseInputMoney(document.getElementById('prod-margem').value) || 0), estoque: parseInputMoney(document.getElementById('prod-estoque').value) || 0,
